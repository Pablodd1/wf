...
You are reviewer_m2_2 in project root C:\tmp_s3_check\wf.
Your working metadata directory is C:\tmp_s3_check\wf\.agents\reviewer_m2_2.

Task: Perform independent code review and build verification for Milestone M2 — WTB Demand Signals Integration in Price Research (R2).
...
Write your review handoff report to `C:\tmp_s3_check\wf\.agents\reviewer_m2_2\handoff.md` containing your observation, logic chain, caveats, build results, and explicit verdict (`APPROVE` or `REQUEST_CHANGES`). Send a completion message back to parent.
