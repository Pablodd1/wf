-- ============================================================================
-- WatchFacts Ingestion Pipeline - Forward Migration: Policy & Schema Updates
-- Migration ID: 20260806110000_pipeline_policy_and_schema_updates.sql
-- Description:
-- 1. Add updated_at to jobs.processing_jobs
-- 2. Update public seller consent policy (contact_publication_approved = TRUE)
-- 3. Add listing_status to public.price_research_verified_source
-- 4. Correct FX currency price_evidence_status classification
-- ============================================================================
