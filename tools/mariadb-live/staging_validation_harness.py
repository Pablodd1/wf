...
try:
    _script = "const { enforceListingDisplayContract } = require('./shared/listing-display-contract.cjs'); console.log(JSON.stringify(Object.keys(enforceListingDisplayContract({}))));"
