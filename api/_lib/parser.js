...
function parseReference(text, brandHint) {
  ...
  for (const pat of ordered) {
    ...
    if (m) {
      ...
      ref = ref
        .replace(/^(\d{5,6})(DAY|DATE|NEW|FULL|SET|USED|LIKE|MINT|GREEN|BLUE|BLACK|WHITE|GOLD|LAND|CHOC|CHOCO|WIM|OLIVE|SUNDUST|TIFFANY|LAVENDER|PISTACHIO|TURQUOISE|PANDA|PAVE|BLK|SILVER|GREY|GRAY|PN|RBOW|SUB|GMT|YM|OP|DJ|DD|DD2|DJ2|EXP|II|I|PINK|BEIGE|AZZURRO|LAVENDER|SUNDUST|INDIGO)$/i, '$1')
        .replace(/^(\d{5,6})(DAY|DATE|NEW|FULL|SET|USED|LIKE|MINT|GREEN|BLUE|BLACK|WHITE|GOLD|LAND|CHOC|CHOCO|WIM|OLIVE|SUNDUST|TIFFANY|LAVENDER|PISTACHIO|TURQUOISE|PANDA|PAVE|BLK|SILVER|GREY|GRAY|PN|RBOW|SUB|GMT|YM|OP|DJ|DD|DD2|DJ2|EXP|II|I|PINK|BEIGE|AZZURRO|LAVENDER|SUNDUST|INDIGO)(?=\d)/i, '$1')
