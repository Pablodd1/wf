...
const translations: Record<Exclude<AppLanguage, 'en'>, Record<string, string>> = {
  es: {
    ...
    'Stop scrolling. Start trading.': 'Deja de desplazarte. Empieza a negociar.', 'Join the verified dealer network already trading through WatchFacts.': 'Únete a la red verificada de distribuidores que ya negocia mediante WatchFacts.',
    'Language': 'Idioma',
  ...
  pt: {
    ...
    'Stop scrolling. Start trading.': 'Pare de rolar. Comece a negociar.', 'Join the verified dealer network already trading through WatchFacts.': 'Entre na rede verificada de revendedores que já negocia pelo WatchFacts.',
    'Language': 'Idioma',
  ...
  zh: {
    ...
    'Stop scrolling. Start trading.': '停止刷屏，开始交易。', 'Join the verified dealer network already trading through WatchFacts.': '加入已经通过 WatchFacts 开展交易的认证经销商网络。',
    'Language': '语言',
