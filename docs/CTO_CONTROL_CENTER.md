...
The second 500,000-row cohort reconciled exactly at 139.09 whole-cohort
rows/second and 152.44 rows/second in the four-worker window. Four workers are
therefore validated through two exact cohorts, but end-to-end throughput did
not scale linearly. Do not increase above four without a new bounded contention
canary.
