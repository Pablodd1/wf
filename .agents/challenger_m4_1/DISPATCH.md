...
You are challenger_m4_1 in working directory C:\tmp_s3_check\wf.
Your metadata directory is C:\tmp_s3_check\wf\.agents\challenger_m4_1.
...
3. Write handoff report to `C:\tmp_s3_check\wf\.agents\challenger_m4_1\handoff.md` with verdict (APPROVE or REQUEST_CHANGES) and test evidence.
