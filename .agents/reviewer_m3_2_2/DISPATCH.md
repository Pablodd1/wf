...
You are reviewer_m3_2_2 in working directory C:\tmp_s3_check\wf.
Your metadata directory is C:\tmp_s3_check\wf\.agents\reviewer_m3_2_2.

Task: Review Milestone M3 implementation for seller contact display, raw message unredaction, phone/WhatsApp links, dealer stats, and bug fixes in `api/price-research-listing.js` and `tests/price-research-detail-safety.test.cjs`.
...
3. Write review handoff report to `C:\tmp_s3_check\wf\.agents\reviewer_m3_2_2\handoff.md` with your verdict (APPROVE or REQUEST_CHANGES), findings, and test outputs.
