...
if (!r.ok || !d.success) throw new Error(d.error || 'References are temporarily unavailable');
  ...
  const fetchData = useCallback(async (
    ...
    try {
      ...
      const researchEndpoint = canaryEnabled ? '/api/canary/price-research' : '/api/price-research';
        ...
        {data && (
          <>
            ...
            <DemandSignalsSection
              ...
              onPageChange={nextPage => void fetchData(data.reference, data.selected_cohort?.dial_color || '', data.brand, cursorIndex + 1, nextPage, selectedCondition, cursorStack[cursorIndex] || null, cursorIndex)}
