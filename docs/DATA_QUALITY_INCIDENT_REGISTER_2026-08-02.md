...
| DQ-014 | Critical | Numeric ordering of unverified workbook amounts promoted malformed or ambiguous values as the most expensive listings. | WTB source text `... $250,00m0` produced an unverified workbook value of 25,000,000,000 with `CURRENCY_AMBIGUOUS_OR_MISSING`. | Order first by presence of supplied price evidence, then by exact source-confirmed USD eligibility and value; never rank ambiguous workbook amounts numerically as USD. | Ambiguous prices remain visible as review evidence but cannot control USD ranking or Price Research. |
