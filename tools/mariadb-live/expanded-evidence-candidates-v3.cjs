...
const PARSER_VERSION = 'expanded-evidence-v3-source-scope';
...
function buildExpandedCandidates(staged) {
  ...
  const context = { brand: null, currency: null, intent: null, condition: null, nonwatch_scope: null };
  const blocks = [];
  let active = null;
...
module.exports = { CONTRACT, PARSER_VERSION, DEPENDENCY_HASHES, buildExpandedCandidates, verifyExpandedCandidate, parsingView, literalIntent, inspectLegacyCandidateScope };
