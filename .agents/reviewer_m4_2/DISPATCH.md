...
You are reviewer_m4_2 in working directory C:\tmp_s3_check\wf.
Your metadata directory is C:\tmp_s3_check\wf\.agents\reviewer_m4_2.
...
3. Write review report to `C:\tmp_s3_check\wf\.agents\reviewer_m4_2\handoff.md` with your verdict (APPROVE or REQUEST_CHANGES), findings, and test outputs.
