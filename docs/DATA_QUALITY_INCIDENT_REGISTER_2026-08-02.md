...
| DQ-003 | High | Seller information was absent or could be inferred from unrelated evidence. | Live Rolex 116500LN source detail returned no poster lineage. | Correct behavior is explicit “not available”; never guess identity or contact. | Customer seller fields require applied lineage and allowed contact use. |
