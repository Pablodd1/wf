...
PostgreSQL 15 and 18 each replay 253 migrations, retaining the six documented
...
These tests use synthetic data only. Full historical capacity with the new
admission ledger, final browser acceptance, remaining test reconciliation,
production discovery and the real canary/full rollout are still release gates.
