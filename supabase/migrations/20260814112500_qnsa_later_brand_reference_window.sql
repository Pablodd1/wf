-- Read one full customer page before applying the reference-key gate.  The
-- earliest reference groups contain legacy parser artifacts; using the caller's
-- smaller limit could otherwise return an empty page even when valid rows follow.
